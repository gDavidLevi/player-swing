...
public class MainFrame extends JFrame implements MainPlayCallbackListener {
    ...
    private void menuItemSavePlaylistActionPerformed(ActionEvent e) {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if (selectedFile.exists()) {
                int resultOvveride = JOptionPane.showConfirmDialog(this, "Файл уже существует", "Перезаписать его?", JOptionPane.YES_NO_CANCEL_OPTION);
    ...
    private void initComponents() {
        ...
        //======== panelVolume ========
        {
            ...
            toggleButtonMute.setSelectedIcon(new ImageIcon(getClass().getResource("/images/ic_speaker_mute.png")));
